...
class EgzersizEtkinlik(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('egzersiz:etkinlik_detay', args=[self.slug])
...
class EgzersizFaaliyetGrubu(models.Model):
    TUR_CHOICES = [
...
class EgzersizFaaliyet(models.Model):
    grup = models.ForeignKey(EgzersizFaaliyetGrubu, on_delete=models.CASCADE, related_name='faaliyetler', verbose_name="Faaliyet Grubu")
...
class EgzersizFaaliyetGorseli(models.Model):
    faaliyet = models.ForeignKey(EgzersizFaaliyet, on_delete=models.CASCADE, related_name='gorseller', verbose_name="Faaliyet")
    gorsel = models.ImageField(upload_to=f'faaliyetler/egzersiz/', verbose_name="Görsel")
    sira = models.IntegerField(default=0, verbose_name="Sıralama")
