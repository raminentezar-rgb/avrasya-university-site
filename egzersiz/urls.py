...
urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.egzersiz_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.egzersiz_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.egzersiz_bolumu, name='egzersiz'),
