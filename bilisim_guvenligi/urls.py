# app_name: bilisim_guvenligi/urls.py

from django.urls import path
from . import views

app_name = 'bilisim_guvenligi'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.bilisim_guvenligi_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.bilisim_guvenligi_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.bilisim_guvenligi_bolumu, name='bilisim_guvenligi'),
