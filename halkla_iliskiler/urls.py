# app_name: halkla_iliskiler/urls.py

from django.urls import path
from . import views

app_name = 'halkla_iliskiler'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.halkla_iliskiler_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.halkla_iliskiler_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.halkla_iliskiler_bolumu, name='halkla_iliskiler'),
