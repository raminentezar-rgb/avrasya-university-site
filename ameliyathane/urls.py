# app_name: ameliyathane/urls.py

from django.urls import path
from . import views

app_name = 'ameliyathane'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.ameliyathane_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.ameliyathane_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.ameliyathane_bolumu, name='ameliyathane'),
