...
from .models import TibbiLaboratuvarDuyuru, TibbiLaboratuvarEtkinlik, TibbiLaboratuvarDersProgrami, TibbiLaboratuvarFaaliyetGrubu
...
def idari_faaliyetler(request):
    gruplar = TibbiLaboratuvarFaaliyetGrubu.objects.filter(faaliyet_turu='idari').prefetch_related('faaliyetler__gorseller')
    return render(request, 'tibbi_laboratuvar/includes/idari_faaliyetler.html', {'gruplar': gruplar})

def diger_faaliyetler(request):
    gruplar = TibbiLaboratuvarFaaliyetGrubu.objects.filter(faaliyet_turu='diger').prefetch_related('faaliyetler__gorseller')
    return render(request, 'tibbi_laboratuvar/includes/diger_faaliyetler.html', {'gruplar': gruplar})
