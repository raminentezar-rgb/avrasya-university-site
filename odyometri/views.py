...
from .models import OdyometriDuyuru, OdyometriEtkinlik, OdyometriDersProgrami, OdyometriFaaliyetGrubu
...
def idari_faaliyetler(request):
    gruplar = OdyometriFaaliyetGrubu.objects.filter(faaliyet_turu='idari').prefetch_related('faaliyetler__gorseller')
    return render(request, 'odyometri/includes/idari_faaliyetler.html', {'gruplar': gruplar})

def diger_faaliyetler(request):
    gruplar = OdyometriFaaliyetGrubu.objects.filter(faaliyet_turu='diger').prefetch_related('faaliyetler__gorseller')
    return render(request, 'odyometri/includes/diger_faaliyetler.html', {'gruplar': gruplar})
