...
app_name = 'insaat_teknolojisi'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.insaat_teknolojisi_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.insaat_teknolojisi_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.insaat_teknolojisi_bolumu, name='insaat_teknolojisi'),
