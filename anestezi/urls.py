...
urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.anestezi_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.anestezi_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.anestezi_bolumu, name='anestezi'),
