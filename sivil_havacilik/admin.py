...
class SivilHavacilikEtkinlikAdmin(TranslationAdmin):
...
@admin.register(SivilHavacilikDuyuru)
class SivilHavacilikDuyuruAdmin(admin.ModelAdmin):
    list_display = ['baslik', 'fakulte', 'yayin_tarihi', 'yayinda']
    list_filter = ['yayinda', 'yayin_tarihi']
    search_fields = ['baslik', 'icerik']
    
    def get_queryset(self, request):
        return SivilHavacilikDuyuru.objects.all()

@admin.register(SivilHavacilikDersProgrami)
class SivilHavacilikDersProgramiAdmin(TranslationAdmin):
...
class SivilHavacilikFaaliyetGrubuAdmin(TranslationAdmin):
    list_display = ['baslik', 'faaliyet_turu', 'sira']
    list_filter = ['faaliyet_turu']
    list_editable = ['sira']

@admin.register(SivilHavacilikFaaliyet)
class SivilHavacilikFaaliyetAdmin(TranslationAdmin):
