...
from .models import IsUgrasiTerapisiDuyuru, IsUgrasiTerapisiEtkinlik, IsUgrasiTerapisiDersProgrami, IsUgrasiTerapisiFaaliyetGrubu
...
def idari_faaliyetler(request):
    gruplar = IsUgrasiTerapisiFaaliyetGrubu.objects.filter(faaliyet_turu='idari').prefetch_related('faaliyetler__gorseller')
    return render(request, 'is_ugrasi_terapisi/includes/idari_faaliyetler.html', {'gruplar': gruplar})

def diger_faaliyetler(request):
    gruplar = IsUgrasiTerapisiFaaliyetGrubu.objects.filter(faaliyet_turu='diger').prefetch_related('faaliyetler__gorseller')
    return render(request, 'is_ugrasi_terapisi/includes/diger_faaliyetler.html', {'gruplar': gruplar})
