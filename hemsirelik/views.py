...
from .models import HemsirelikDuyuru, HemsirelikEtkinlik, HemsirelikDersProgrami, HemsirelikFaaliyetGrubu
...
def idari_faaliyetler(request):
    gruplar = HemsirelikFaaliyetGrubu.objects.filter(faaliyet_turu='idari').prefetch_related('faaliyetler__gorseller')
    return render(request, 'hemsirelik/includes/idari_faaliyetler.html', {'gruplar': gruplar})

def diger_faaliyetler(request):
    gruplar = HemsirelikFaaliyetGrubu.objects.filter(faaliyet_turu='diger').prefetch_related('faaliyetler__gorseller')
    return render(request, 'hemsirelik/includes/diger_faaliyetler.html', {'gruplar': gruplar})
