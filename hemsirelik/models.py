...
class HemsirelikEtkinlik(models.Model):
    ...
    class Meta:
        ...
        verbose_name = "Etkinlik (Hemşirelik)"
        verbose_name_plural = "Etkinlikler (Hemşirelik)"

    def __str__(self):
        return self.baslik

    def get_absolute_url(self):
        return reverse('hemsirelik:etkinlik_detay', args=[self.slug])
...
class HemsirelikFaaliyetGrubu(models.Model):
    TUR_CHOICES = [
...
class HemsirelikFaaliyet(models.Model):
    grup = models.ForeignKey(HemsirelikFaaliyetGrubu, on_delete=models.CASCADE, related_name='faaliyetler', verbose_name="Faaliyet Grubu")
...
class HemsirelikFaaliyetGorseli(models.Model):
    faaliyet = models.ForeignKey(HemsirelikFaaliyet, on_delete=models.CASCADE, related_name='gorseller', verbose_name="Faaliyet")
    gorsel = models.ImageField(upload_to=f'faaliyetler/hemsirelik/', verbose_name="Görsel")
    sira = models.IntegerField(default=0, verbose_name="Sıralama")
