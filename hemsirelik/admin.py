...
class HemsirelikEtkinlikAdmin(TranslationAdmin):
...
class HemsirelikDersProgramiAdmin(TranslationAdmin):
...
class HemsirelikFaaliyetGrubuAdmin(TranslationAdmin):
    list_display = ['baslik', 'faaliyet_turu', 'sira']
    list_filter = ['faaliyet_turu']
    list_editable = ['sira']

@admin.register(HemsirelikFaaliyet)
class HemsirelikFaaliyetAdmin(TranslationAdmin):
