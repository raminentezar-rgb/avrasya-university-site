...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('hemsirelik', '0002_hemsirelikdersprogrami_and_more'),
    ]

    operations = [
        migrations.CreateModel(
            name='HemsirelikEtkinlik',
            fields=[
                ...
                ('afis', models.ImageField(blank=True, null=True, upload_to='etkinlikler/afis/hemsirelik/%Y/%m/%d/', verbose_name='Etkinlik Afişi')),
