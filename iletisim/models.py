...
class IletisimDuyuru(models.Model):
    # لینک به اطلاعیه اصلی
    ana_duyuru = models.OneToOneField(
        Duyuru, 
        on_delete=models.CASCADE,
        related_name='iletisim_duyuru',
    ...
    # فایل‌های ضمیمه
    dosya = models.FileField(upload_to='iletisim/duyurular/', blank=True, null=True, verbose_name="Dosya Eki")
    ...
    class Meta:
        verbose_name = "İletişim Duyurusu"
        verbose_name_plural = "İletişim Duyuruları"
    ...
    def get_absolute_url(self):
        return reverse('iletisim:duyuru_detay', args=[self.id])
