# app_name: sosyal_guvenlik/urls.py

from django.urls import path
from . import views

app_name = 'sosyal_guvenlik'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.sosyal_guvenlik_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.sosyal_guvenlik_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.sosyal_guvenlik_bolumu, name='sosyal_guvenlik'),
