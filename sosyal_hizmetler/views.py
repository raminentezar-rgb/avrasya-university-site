...
from .models import SosyalHizmetlerDuyuru, SosyalHizmetlerEtkinlik, SosyalHizmetlerDersProgrami, SosyalHizmetlerFaaliyetGrubu
...
def idari_faaliyetler(request):
    gruplar = SosyalHizmetlerFaaliyetGrubu.objects.filter(faaliyet_turu='idari').prefetch_related('faaliyetler__gorseller')
    return render(request, 'sosyal_hizmetler/includes/idari_faaliyetler.html', {'gruplar': gruplar})

def diger_faaliyetler(request):
    gruplar = SosyalHizmetlerFaaliyetGrubu.objects.filter(faaliyet_turu='diger').prefetch_related('faaliyetler__gorseller')
    return render(request, 'sosyal_hizmetler/includes/diger_faaliyetler.html', {'gruplar': gruplar})
