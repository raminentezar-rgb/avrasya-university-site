...
class SosyalHizmetlerEtkinlikAdmin(TranslationAdmin):
...
@admin.register(SosyalHizmetlerDuyuru)
class SosyalHizmetlerDuyuruAdmin(admin.ModelAdmin):
    list_display = ['baslik', 'fakulte', 'yayin_tarihi', 'yayinda']
    list_filter = ['yayinda', 'yayin_tarihi']
    search_fields = ['baslik', 'icerik']
    
    def get_queryset(self, request):
        return SosyalHizmetlerDuyuru.objects.all()

@admin.register(SosyalHizmetlerDersProgrami)
class SosyalHizmetlerDersProgramiAdmin(TranslationAdmin):
...
class SosyalHizmetlerFaaliyetGrubuAdmin(TranslationAdmin):
    list_display = ['baslik', 'faaliyet_turu', 'sira']
    list_filter = ['faaliyet_turu']
    list_editable = ['sira']

@admin.register(SosyalHizmetlerFaaliyet)
class SosyalHizmetlerFaaliyetAdmin(TranslationAdmin):
