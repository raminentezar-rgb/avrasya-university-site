# app_name: sosyal_hizmetler/urls.py

from django.urls import path
from . import views

app_name = 'sosyal_hizmetler'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.sosyal_hizmetler_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.sosyal_hizmetler_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.sosyal_hizmetler_bolumu, name='sosyal_hizmetler'),
