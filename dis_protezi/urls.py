# file name: dis_protezi/urls.py

from django.urls import path
from . import views

app_name = 'dis_protezi'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.dis_protezi_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.dis_protezi_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.dis_protezi_bolumu, name='dis_protezi'),
