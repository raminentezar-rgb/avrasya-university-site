...
from .models import DisProteziDuyuru, DisProteziEtkinlik, DisProteziDersProgrami, DisProteziFaaliyetGrubu
...
def idari_faaliyetler(request):
    gruplar = DisProteziFaaliyetGrubu.objects.filter(faaliyet_turu='idari').prefetch_related('faaliyetler__gorseller')
    return render(request, 'dis_protezi/includes/idari_faaliyetler.html', {'gruplar': gruplar})

def diger_faaliyetler(request):
    gruplar = DisProteziFaaliyetGrubu.objects.filter(faaliyet_turu='diger').prefetch_related('faaliyetler__gorseller')
    return render(request, 'dis_protezi/includes/diger_faaliyetler.html', {'gruplar': gruplar})
