...
from .models import OptisyenlikDuyuru, OptisyenlikEtkinlik, OptisyenlikDersProgrami, OptisyenlikFaaliyetGrubu
...
def idari_faaliyetler(request):
    gruplar = OptisyenlikFaaliyetGrubu.objects.filter(faaliyet_turu='idari').prefetch_related('faaliyetler__gorseller')
    return render(request, 'optisyenlik/includes/idari_faaliyetler.html', {'gruplar': gruplar})

def diger_faaliyetler(request):
    gruplar = OptisyenlikFaaliyetGrubu.objects.filter(faaliyet_turu='diger').prefetch_related('faaliyetler__gorseller')
    return render(request, 'optisyenlik/includes/diger_faaliyetler.html', {'gruplar': gruplar})
