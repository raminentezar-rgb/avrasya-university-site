# app_name: optisyenlik/urls.py

from django.urls import path
from . import views

app_name = 'optisyenlik'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.optisyenlik_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.optisyenlik_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.optisyenlik_bolumu, name='optisyenlik'),
