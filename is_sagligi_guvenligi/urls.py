# app_name: is_sagligi_guvenligi/urls.py

from django.urls import path
from . import views

app_name = 'is_sagligi_guvenligi'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.is_sagligi_guvenligi_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.is_sagligi_guvenligi_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.is_sagligi_guvenligi_bolumu, name='is_sagligi_guvenligi'),
