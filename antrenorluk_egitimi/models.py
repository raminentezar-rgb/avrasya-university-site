# app_name: antrenorluk_egitimi/models.py
...
class AntrenorlukEgitimiEtkinlik(models.Model):
    ...
    class Meta:
        ...
        verbose_name = "Etkinlik (Antrenörlük Eğitimi)"
        verbose_name_plural = "Etkinlikler (Antrenörlük Eğitimi)"

    def __str__(self):
        return self.baslik

    def get_absolute_url(self):
        return reverse('antrenorluk_egitimi:etkinlik_detay', args=[self.slug])
...
class AntrenorlukEgitimiFaaliyetGrubu(models.Model):
    TUR_CHOICES = [
...
class AntrenorlukEgitimiFaaliyet(models.Model):
    grup = models.ForeignKey(AntrenorlukEgitimiFaaliyetGrubu, on_delete=models.CASCADE, related_name='faaliyetler', verbose_name="Faaliyet Grubu")
...
class AntrenorlukEgitimiFaaliyetGorseli(models.Model):
    faaliyet = models.ForeignKey(AntrenorlukEgitimiFaaliyet, on_delete=models.CASCADE, related_name='gorseller', verbose_name="Faaliyet")
    gorsel = models.ImageField(upload_to=f'faaliyetler/antrenorluk_egitimi/', verbose_name="Görsel")
    sira = models.IntegerField(default=0, verbose_name="Sıralama")
