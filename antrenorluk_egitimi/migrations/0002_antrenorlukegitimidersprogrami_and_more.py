# Generated by Django 6.0 on 2026-02-18 06:34
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('antrenorluk_egitimi', '0001_initial'),
    ]

    operations = [
        migrations.CreateModel(
            name='AntrenorlukEgitimiDersProgrami',
            fields=[
        ...
        migrations.CreateModel(
            name='AntrenorlukEgitimiEtkinlik',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('afis', models.ImageField(blank=True, null=True, upload_to='etkinlikler/afis/antrenorluk_egitimi/%Y/%m/%d/', verbose_name='Etkinlik Afişi')),
        ...
        migrations.DeleteModel(
            name='Antrenorluk_Etkinlik',
        ),
        migrations.DeleteModel(
            name='AntrenorlukDersProgrami',
        ),
    ]
