...
@admin.register(Antrenorluk_Etkinlik)
class Antrenorluk_EtkinlikAdmin(admin.ModelAdmin):
...
@admin.register(AntrenorlukDersProgrami)
class AntrenorlukDersProgramiAdmin(admin.ModelAdmin):
