...
class Ascilik_EtkinlikAdmin(TranslationAdmin):
...
@admin.register(AscilikDuyuru)
class AscilikDuyuruAdmin(admin.ModelAdmin):
    list_display = ['baslik', 'fakulte', 'yayin_tarihi', 'yayinda']
    list_filter = ['yayinda', 'yayin_tarihi']
    search_fields = ['baslik', 'icerik']
    
    def get_queryset(self, request):
        return AscilikDuyuru.objects.all()

@admin.register(AscilikDersProgrami)
class AscilikDersProgramiAdmin(TranslationAdmin):
...
class AscilikFaaliyetGrubuAdmin(TranslationAdmin):
    list_display = ['baslik', 'faaliyet_turu', 'sira']
    list_filter = ['faaliyet_turu']
    list_editable = ['sira']

@admin.register(AscilikFaaliyet)
class AscilikFaaliyetAdmin(TranslationAdmin):
