...
class CocukGelisimiEtkinlikAdmin(TranslationAdmin):
...
class CocukGelisimiDersProgramiAdmin(TranslationAdmin):
...
class CocukGelisimiProgramiFaaliyetGrubuAdmin(TranslationAdmin):
    list_display = ['baslik', 'faaliyet_turu', 'sira']
    list_filter = ['faaliyet_turu']
    list_editable = ['sira']

@admin.register(CocukGelisimiProgramiFaaliyet)
class CocukGelisimiProgramiFaaliyetAdmin(TranslationAdmin):
