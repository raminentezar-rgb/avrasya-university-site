# app_name: spor_yonetimi/urls.py

from django.urls import path
from . import views

app_name = 'spor_yonetimi'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.spor_yonetimi_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.spor_yonetimi_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.spor_yonetimi_bolumu, name='spor_yonetimi'),
