...
from .models import GidaMuhendisligiDuyuru, GidaMuhendisligiEtkinlik, GidaMuhendisligiDersProgrami, GidaMuhendisligiFaaliyetGrubu
...
def idari_faaliyetler(request):
    gruplar = GidaMuhendisligiFaaliyetGrubu.objects.filter(faaliyet_turu='idari').prefetch_related('faaliyetler__gorseller')
    return render(request, 'gida_muhendisligi/includes/idari_faaliyetler.html', {'gruplar': gruplar})

def diger_faaliyetler(request):
    gruplar = GidaMuhendisligiFaaliyetGrubu.objects.filter(faaliyet_turu='diger').prefetch_related('faaliyetler__gorseller')
    return render(request, 'gida_muhendisligi/includes/diger_faaliyetler.html', {'gruplar': gruplar})
