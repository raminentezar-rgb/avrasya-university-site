# app_name: gida_muhendisligi/urls.py

from django.urls import path
from . import views

app_name = 'gida_muhendisligi'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.gida_muhendisligi_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.gida_muhendisligi_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.gida_muhendisligi_bolumu, name='gida_muhendisligi'),
