# app_name: web_tasarimi/urls.py

from django.urls import path
from . import views

app_name = 'web_tasarimi'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.web_tasarimi_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.web_tasarimi_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.web_tasarimi_bolumu, name='web_tasarimi'),
