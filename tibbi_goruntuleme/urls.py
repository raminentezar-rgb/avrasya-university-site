# app_name: tibbi_goruntuleme/urls.py

from django.urls import path
from . import views

app_name = 'tibbi_goruntuleme'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.tibbi_goruntuleme_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.tibbi_goruntuleme_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.tibbi_goruntuleme_bolumu, name='tibbi_goruntuleme'),
