# app_name: sosyal_hizmet/urls.py

from django.urls import path
from . import views

app_name = 'sosyal_hizmet'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.sosyal_hizmet_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.sosyal_hizmet_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.sosyal_hizmet_bolumu, name='sosyal_hizmet'),
