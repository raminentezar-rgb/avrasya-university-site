# Generated by Django 4.2.23 on 2026-02-18 05:42
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('sosyal_hizmet', '0002_sosyal_etkinlik_sosyaldersprogrami_and_more'),
    ]

    operations = [
        migrations.CreateModel(
            name='SosyalHizmetEtkinlik',
            fields=[
                ...
                ('afis', models.ImageField(blank=True, null=True, upload_to='etkinlikler/afis/sosyal_hizmet/%Y/%m/%d/', verbose_name='Etkinlik Afişi')),
        ...
        migrations.RenameModel(
            old_name='SosyalDersProgrami',
            new_name='SosyalHizmetDersProgrami',
        ),
