...
class SosyalHizmetEtkinlikAdmin(TranslationAdmin):
...
class SosyalHizmetDersProgramiAdmin(TranslationAdmin):
...
class SosyalHizmetFaaliyetGrubuAdmin(TranslationAdmin):
    list_display = ['baslik', 'faaliyet_turu', 'sira']
    list_filter = ['faaliyet_turu']
    list_editable = ['sira']

@admin.register(SosyalHizmetFaaliyet)
class SosyalHizmetFaaliyetAdmin(TranslationAdmin):
