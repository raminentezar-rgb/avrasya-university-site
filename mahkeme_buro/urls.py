# app_name: mahkeme_buro/urls.py

from django.urls import path
from . import views

app_name = 'mahkeme_buro'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.mahkeme_buro_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.mahkeme_buro_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.mahkeme_buro_bolumu, name='mahkeme_buro'),
