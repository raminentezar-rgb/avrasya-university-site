...
def idari_faaliyetler_2024_2025(request):
    return render(request, 'isletme_ingilizce/includes/idari_faaliyetler_2024_2025.html')

def diger_faaliyetler_2024_2025(request):
    return render(request, 'isletme_ingilizce/includes/diger_faaliyetler_2024_2025.html')
