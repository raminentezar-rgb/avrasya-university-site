# app_name: radyoterapi/urls.py

from django.urls import path
from . import views

app_name = 'radyoterapi'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.radyoterapi_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.radyoterapi_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.radyoterapi_bolumu, name='radyoterapi'),
