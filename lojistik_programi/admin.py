...
class LojistikProgramiEtkinlikAdmin(TranslationAdmin):
...
@admin.register(LojistikProgramiDuyuru)
class LojistikProgramiDuyuruAdmin(admin.ModelAdmin):
    list_display = ['baslik', 'fakulte', 'yayin_tarihi', 'yayinda']
    list_filter = ['yayinda', 'yayin_tarihi']
    search_fields = ['baslik', 'icerik']
    
    def get_queryset(self, request):
        return LojistikProgramiDuyuru.objects.all()

@admin.register(LojistikProgramiDersProgrami)
class LojistikProgramiDersProgramiAdmin(TranslationAdmin):
...
class LojistikProgramiFaaliyetGrubuAdmin(TranslationAdmin):
    list_display = ['baslik', 'faaliyet_turu', 'sira']
    list_filter = ['faaliyet_turu']
    list_editable = ['sira']

@admin.register(LojistikProgramiFaaliyet)
class LojistikProgramiFaaliyetAdmin(TranslationAdmin):
