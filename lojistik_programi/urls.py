# app_name: lojistik_programi/urls.py

from django.urls import path
from . import views

app_name = 'lojistik_programi'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.lojistik_programi_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.lojistik_programi_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.lojistik_programi_bolumu, name='lojistik_programi'),
