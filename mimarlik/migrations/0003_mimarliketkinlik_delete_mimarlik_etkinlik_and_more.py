# Generated by Django 6.0 on 2026-02-12 07:59
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mimarlik', '0002_mimarlikdersprogrami_and_more'),
    ]

    operations = [
        migrations.CreateModel(
            name='MimarlikEtkinlik',
            fields=[
                ...
                ('afis', models.ImageField(blank=True, null=True, upload_to='etkinlikler/afis/mimarlik/%Y/%m/%d/', verbose_name='Etkinlik Afişi')),
        ...
        migrations.AlterField(
            ...
            name='sinif',
            field=models.CharField(choices=[('1', '1. Sınıf'), ('2', '2. Sınıf'), ('3', '3. Sınıf'), ('4', '4. Sınıf'), ('tum', 'Tüm Sınıflar')], max_length=10, verbose_name='Sınıf'),
        ),
    ]
