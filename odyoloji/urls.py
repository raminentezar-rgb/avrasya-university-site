...
urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.odyoloji_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.odyoloji_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.odyoloji_bolumu, name='odyoloji'),
