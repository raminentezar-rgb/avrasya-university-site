# app_name: turk_dili_edebiyati/urls.py

from django.urls import path
from . import views

app_name = 'turk_dili_edebiyati'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.turk_dili_edebiyati_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.turk_dili_edebiyati_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.turk_dili_edebiyati_bolumu, name='turk_dili_edebiyati'),
