...
@admin.register(Turk_Etkinlik)
class Turk_EtkinlikAdmin(admin.ModelAdmin):
...
@admin.register(TurkDiliEdebiyatiDuyuru)
class TurkDiliEdebiyatiDuyuruAdmin(admin.ModelAdmin):
...
@admin.register(TurkDersProgrami)
class TurkDersProgramiAdmin(admin.ModelAdmin):
