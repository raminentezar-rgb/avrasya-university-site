...
from .models import ElektrikElektronikMuhendisligiDuyuru, ElektrikElektronikMuhendisligiEtkinlik, ElektrikElektronikMuhendisligiDersProgrami, ElektrikElektronikMuhendisligiFaaliyetGrubu
...
def idari_faaliyetler(request):
    gruplar = ElektrikElektronikMuhendisligiFaaliyetGrubu.objects.filter(faaliyet_turu='idari').prefetch_related('faaliyetler__gorseller')
    return render(request, 'elektrik_elektronik_muhendisligi/includes/idari_faaliyetler.html', {'gruplar': gruplar})

def diger_faaliyetler(request):
    gruplar = ElektrikElektronikMuhendisligiFaaliyetGrubu.objects.filter(faaliyet_turu='diger').prefetch_related('faaliyetler__gorseller')
    return render(request, 'elektrik_elektronik_muhendisligi/includes/diger_faaliyetler.html', {'gruplar': gruplar})
