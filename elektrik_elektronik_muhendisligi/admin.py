...
@admin.register(Elektrik_Etkinlik)
class Elektrik_EtkinlikAdmin(admin.ModelAdmin):
...
@admin.register(ElektrikDersProgrami)
class ElektrikDersProgramiAdmin(admin.ModelAdmin):
