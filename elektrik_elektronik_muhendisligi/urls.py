# app_name: elektrik_elektronik_muhendisligi/urls.py

from django.urls import path
from . import views

app_name = 'elektrik_elektronik_muhendisligi'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.elektrik_elektronik_muhendisligi_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.elektrik_elektronik_muhendisligi_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.elektrik_elektronik_muhendisligi_bolumu, name='elektrik_elektronik_muhendisligi'),
