# app_name: mimari_restorasyon/urls.py

from django.urls import path
from . import views

app_name = 'mimari_restorasyon'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.mimari_restorasyon_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.mimari_restorasyon_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.mimari_restorasyon_bolumu, name='mimari_restorasyon'),
