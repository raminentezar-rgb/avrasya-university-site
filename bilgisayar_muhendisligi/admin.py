...
@admin.register(Bilgisayar_Etkinlik)
class Bilgisayar_EtkinlikAdmin(admin.ModelAdmin):
...
@admin.register(BilgisayarMuhendisligiDuyuru)
class BilgisayarMuhendisligiDuyuruAdmin(admin.ModelAdmin):
...
@admin.register(BilgisayarDersProgrami)
class BilgisayarDersProgramiAdmin(admin.ModelAdmin):
