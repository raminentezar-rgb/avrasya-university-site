# app_name: bilgisayar_muhendisligi/urls.py

from django.urls import path
from . import views

app_name = 'bilgisayar_muhendisligi'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.bilgisayar_muhendisligi_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.bilgisayar_muhendisligi_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.bilgisayar_muhendisligi_bolumu, name='bilgisayar_muhendisligi'),
