...
@admin.register(Harita_Etkinlik)
class Harita_EtkinlikAdmin(admin.ModelAdmin):
...
@admin.register(HaritaDersProgrami)
class HaritaDersProgramiAdmin(admin.ModelAdmin):
