...
class HaritaMuhendisligiEtkinlikAdmin(TranslationAdmin):
...
class HaritaMuhendisligiDersProgramiAdmin(TranslationAdmin):
...
class HaritaMuhendisligiFaaliyetGrubuAdmin(TranslationAdmin):
    list_display = ['baslik', 'faaliyet_turu', 'sira']
    list_filter = ['faaliyet_turu']
    list_editable = ['sira']

@admin.register(HaritaMuhendisligiFaaliyet)
class HaritaMuhendisligiFaaliyetAdmin(TranslationAdmin):
