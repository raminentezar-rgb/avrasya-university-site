...
urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.rekreasyon_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.rekreasyon_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.rekreasyon_bolumu, name='rekreasyon'),
