...
from .models import (
    SaglikYonetimiFaaliyetGrubu, SaglikYonetimiFaaliyetGorseli, SaglikYonetimiDersProgrami, SaglikYonetimiEtkinlik, SaglikYonetimiFaaliyet, SaglikYonetimiDuyuru
)

@admin.register(SaglikYonetimiEtkinlik)
class SaglikYonetimiEtkinlikAdmin(TranslationAdmin):
...
@admin.register(SaglikYonetimiDuyuru)
class SaglikYonetimiDuyuruAdmin(admin.ModelAdmin):
...
class SaglikYonetimiDersProgramiAdmin(TranslationAdmin):
...
class SaglikYonetimiFaaliyetGorseliInline(admin.TabularInline):
    model = SaglikYonetimiFaaliyetGorseli
    extra = 1

@admin.register(SaglikYonetimiFaaliyetGrubu)
class SaglikYonetimiFaaliyetGrubuAdmin(TranslationAdmin):
    list_display = ['baslik', 'faaliyet_turu', 'sira']
    list_filter = ['faaliyet_turu']
    list_editable = ['sira']

@admin.register(SaglikYonetimiFaaliyet)
class SaglikYonetimiFaaliyetAdmin(TranslationAdmin):
    list_display = ['baslik', 'grup', 'tarih', 'sira']
    list_filter = ['grup__faaliyet_turu', 'grup']
    list_editable = ['sira']
    search_fields = ['baslik', 'icerik']
    inlines = [SaglikYonetimiFaaliyetGorseliInline]
