# app_name: grafik_tasarimi/urls.py

from django.urls import path
from . import views

app_name = 'grafik_tasarimi'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.grafik_tasarimi_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.grafik_tasarimi_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.grafik_tasarimi_bolumu, name='grafik_tasarimi'),
