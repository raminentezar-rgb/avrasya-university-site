...
class GrafikTasarimiEtkinlikAdmin(TranslationAdmin):
...
class GrafikTasarimiDersProgramiAdmin(TranslationAdmin):
...
class GrafikTasarimiFaaliyetGrubuAdmin(TranslationAdmin):
    list_display = ['baslik', 'faaliyet_turu', 'sira']
    list_filter = ['faaliyet_turu']
    list_editable = ['sira']

@admin.register(GrafikTasarimiFaaliyet)
class GrafikTasarimiFaaliyetAdmin(TranslationAdmin):
