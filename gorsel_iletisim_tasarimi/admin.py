...
class Gorsel_EtkinlikAdmin(TranslationAdmin):
...
@admin.register(GorselIletisimTasarimiDuyuru)
class GorselIletisimTasarimiDuyuruAdmin(admin.ModelAdmin):
    list_display = ['baslik', 'fakulte', 'yayin_tarihi', 'yayinda']
    list_filter = ['yayinda', 'yayin_tarihi']
    search_fields = ['baslik', 'icerik']
    
    def get_queryset(self, request):
        return GorselIletisimTasarimiDuyuru.objects.all()

@admin.register(GorselDersProgrami)
class GorselDersProgramiAdmin(TranslationAdmin):
...
class GorselIletisimTasarimiFaaliyetGrubuAdmin(TranslationAdmin):
    list_display = ['baslik', 'faaliyet_turu', 'sira']
    list_filter = ['faaliyet_turu']
    list_editable = ['sira']

@admin.register(GorselIletisimTasarimiFaaliyet)
class GorselIletisimTasarimiFaaliyetAdmin(TranslationAdmin):
