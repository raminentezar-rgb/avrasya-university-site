# app_name: gorsel_iletisim_tasarimi/urls.py

from django.urls import path
from . import views

app_name = 'gorsel_iletisim_tasarimi'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.gorsel_iletisim_tasarimi_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.gorsel_iletisim_tasarimi_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.gorsel_iletisim_tasarimi, name='gorsel_iletisim_tasarimi'),
