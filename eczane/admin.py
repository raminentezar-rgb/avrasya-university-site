...
class EczaneEtkinlikAdmin(TranslationAdmin):
...
@admin.register(EczaneDuyuru)
class EczaneDuyuruAdmin(admin.ModelAdmin):
    list_display = ['baslik', 'fakulte', 'yayin_tarihi', 'yayinda']
    list_filter = ['yayinda', 'yayin_tarihi']
    search_fields = ['baslik', 'icerik']
    
    def get_queryset(self, request):
        return EczaneDuyuru.objects.all()

@admin.register(EczaneDersProgrami)
class EczaneDersProgramiAdmin(TranslationAdmin):
...
class EczaneFaaliyetGrubuAdmin(TranslationAdmin):
    list_display = ['baslik', 'faaliyet_turu', 'sira']
    list_filter = ['faaliyet_turu']
    list_editable = ['sira']

@admin.register(EczaneFaaliyet)
class EczaneFaaliyetAdmin(TranslationAdmin):
