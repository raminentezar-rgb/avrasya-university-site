...
class OrtopedikProtezEtkinlikAdmin(TranslationAdmin):
...
@admin.register(OrtopedikProtezDuyuru)
class OrtopedikProtezDuyuruAdmin(admin.ModelAdmin):
    list_display = ['baslik', 'fakulte', 'yayin_tarihi', 'yayinda']
    list_filter = ['yayinda', 'yayin_tarihi']
    search_fields = ['baslik', 'icerik']
    
    def get_queryset(self, request):
        return OrtopedikProtezDuyuru.objects.all()

@admin.register(OrtopedikProtezDersProgrami)
class OrtopedikProtezDersProgramiAdmin(TranslationAdmin):
...
class OrtopedikProtezFaaliyetGrubuAdmin(TranslationAdmin):
    list_display = ['baslik', 'faaliyet_turu', 'sira']
    list_filter = ['faaliyet_turu']
    list_editable = ['sira']

@admin.register(OrtopedikProtezFaaliyet)
class OrtopedikProtezFaaliyetAdmin(TranslationAdmin):
