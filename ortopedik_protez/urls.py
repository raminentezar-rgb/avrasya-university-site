# app_name: ortopedik_protez/urls.py

from django.urls import path
from . import views

app_name = 'ortopedik_protez'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.ortopedik_protez_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.ortopedik_protez_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.ortopedik_protez_bolumu, name='ortopedik_protez'),
