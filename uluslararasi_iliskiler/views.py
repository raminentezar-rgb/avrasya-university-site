...
from .models import UluslararasiIliskilerDuyuru, UluslararasiIliskilerEtkinlik, UluslararasiIliskilerDersProgrami
...
def idari_faaliyetler_2024_2025(request):
    return render(request, 'uluslararasi_iliskiler/includes/idari_faaliyetler_2024_2025.html')

def diger_faaliyetler_2024_2025(request):
    return render(request, 'uluslararasi_iliskiler/includes/diger_faaliyetler_2024_2025.html')
