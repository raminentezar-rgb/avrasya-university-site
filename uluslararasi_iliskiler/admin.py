...
@admin.register(UluslararasiIliskiler_Etkinlik)
class UluslararasiIliskiler_EtkinlikAdmin(admin.ModelAdmin):
...
@admin.register(DersProgramiDosyaUluslararasiIliskiler)
class DersProgramiDosyaUluslararasiIliskilerAdmin(admin.ModelAdmin):
