# app_name: ilk_acil_yardim/urls.py

from django.urls import path
from . import views

app_name = 'ilk_acil_yardim'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.ilk_acil_yardim_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.ilk_acil_yardim_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.ilk_acil_yardim_bolumu, name='ilk_acil_yardim'),
