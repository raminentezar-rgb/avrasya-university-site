...
@admin.register(Insaat_Etkinlik)
class Insaat_EtkinlikAdmin(admin.ModelAdmin):
...
@admin.register(InsaatDersProgrami)
class InsaatDersProgramiAdmin(admin.ModelAdmin):
