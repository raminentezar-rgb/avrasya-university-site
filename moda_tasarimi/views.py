...
from .models import ModaTasarimiDuyuru, ModaTasarimiEtkinlik, ModaTasarimiDersProgrami, ModaTasarimiFaaliyetGrubu
...
def idari_faaliyetler(request):
    gruplar = ModaTasarimiFaaliyetGrubu.objects.filter(faaliyet_turu='idari').prefetch_related('faaliyetler__gorseller')
    return render(request, 'moda_tasarimi/includes/idari_faaliyetler.html', {'gruplar': gruplar})

def diger_faaliyetler(request):
    gruplar = ModaTasarimiFaaliyetGrubu.objects.filter(faaliyet_turu='diger').prefetch_related('faaliyetler__gorseller')
    return render(request, 'moda_tasarimi/includes/diger_faaliyetler.html', {'gruplar': gruplar})
