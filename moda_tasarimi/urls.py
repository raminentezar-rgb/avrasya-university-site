# app_name: moda_tasarimi/urls.py

from django.urls import path
from . import views

app_name = 'moda_tasarimi'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.moda_tasarimi_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.moda_tasarimi_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.moda_tasarimi_bolumu, name='moda_tasarimi'),
