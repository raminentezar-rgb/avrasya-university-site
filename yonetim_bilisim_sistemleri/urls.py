# app_name: yonetim_bilisim_sistemleri/urls.py

from django.urls import path
from . import views

app_name = 'yonetim_bilisim'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.yonetim_bilisim_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.yonetim_bilisim_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.yonetim_bilisim_bolumu, name='yonetim_bilisim'),
