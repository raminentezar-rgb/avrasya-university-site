# app_name: patoloji_laboratuar/urls.py

from django.urls import path
from . import views

app_name = 'patoloji_laboratuar'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.patoloji_laboratuar_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.patoloji_laboratuar_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.patoloji_laboratuar_bolumu, name='patoloji_laboratuar'),
