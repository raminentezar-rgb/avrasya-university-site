...
class PatolojiLaboratuarEtkinlikAdmin(TranslationAdmin):
...
@admin.register(PatolojiLaboratuarDuyuru)
class PatolojiLaboratuarDuyuruAdmin(admin.ModelAdmin):
    list_display = ['baslik', 'fakulte', 'yayin_tarihi', 'yayinda']
    list_filter = ['yayinda', 'yayin_tarihi']
    search_fields = ['baslik', 'icerik']
    
    def get_queryset(self, request):
        return PatolojiLaboratuarDuyuru.objects.all()

@admin.register(PatolojiLaboratuarDersProgrami)
class PatolojiLaboratuarDersProgramiAdmin(TranslationAdmin):
...
class PatolojiLaboratuarFaaliyetGrubuAdmin(TranslationAdmin):
    list_display = ['baslik', 'faaliyet_turu', 'sira']
    list_filter = ['faaliyet_turu']
    list_editable = ['sira']

@admin.register(PatolojiLaboratuarFaaliyet)
class PatolojiLaboratuarFaaliyetAdmin(TranslationAdmin):
