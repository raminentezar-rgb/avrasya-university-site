# uygulamali_bilimler/models.py
from django.db import models
from django.urls import reverse
from duyurular.models import Duyuru, DuyuruDosya

class UygulamaliBilimlerDuyuru(models.Model):
    ana_duyuru = models.OneToOneField(
        Duyuru, 
        on_delete=models.CASCADE,
        related_name='uygulamali_bilimler_duyuru',
    ...
    dosya = models.FileField(upload_to='uygulamali_bilimler/duyurular/', blank=True, null=True, verbose_name="Dosya Eki")
    ...
    class Meta:
        verbose_name = "Uygulamalı Bilimler Duyurusu"
        verbose_name_plural = "Uygulamalı Bilimler Duyuruları"
    ...
    def get_absolute_url(self):
        return reverse('uygulamali_bilimler:duyuru_detay', args=[self.id])
...
class UygulamaliBilimlerDosya(models.Model):
    DOSYA_TURleri = [
        ('word', 'Word Belgesi'),
        ('pdf', 'PDF Belgesi'),
        ('excel', 'Excel Dosyası'),
    ...
    dosya = models.FileField(
        upload_to='uygulamali_bilimler/dosyalar/%Y/%m/%d/',
        verbose_name="Dosya"
    )
