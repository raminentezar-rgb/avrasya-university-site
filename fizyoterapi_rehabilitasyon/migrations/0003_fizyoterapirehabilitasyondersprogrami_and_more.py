# Generated by Django 6.0 on 2026-02-17 05:24
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('fizyoterapi_rehabilitasyon', '0002_fizyoterapi_etkinlik_fizyoterapidersprogrami_and_more'),
    ]

    operations = [
        migrations.CreateModel(
            name='FizyoterapiRehabilitasyonDersProgrami',
            fields=[
        ...
        migrations.CreateModel(
            name='FizyoterapiRehabilitasyonEtkinlik',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('afis', models.ImageField(blank=True, null=True, upload_to='etkinlikler/afis/fizyoterapi_rehabilitasyon/%Y/%m/%d/', verbose_name='Etkinlik Afişi')),
        ...
        migrations.AlterModelOptions(
            ...
            options={'verbose_name': 'Fizyoterapi Duyurusu', 'verbose_name_plural': 'Fizyoterapi Duyuruları'},
        ),
    ]
