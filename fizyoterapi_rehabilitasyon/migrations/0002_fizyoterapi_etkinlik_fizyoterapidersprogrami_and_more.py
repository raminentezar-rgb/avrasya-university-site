# Generated by Django 6.0 on 2026-01-13 07:12
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('fizyoterapi_rehabilitasyon', '0001_initial'),
    ]

    operations = [
        migrations.CreateModel(
            name='Fizyoterapi_Etkinlik',
            fields=[
                ...
                ('etkinlik_turu', models.CharField(choices=[('konferans', 'Konferans / Kongre / Sempozyum'), ('seminer', 'Seminer / Panel'), ('klinik', 'Klinik Eğitim / Uygulama'), ('workshop', 'Workshop / Atölye'), ('kongre', 'Ulusal / Uluslararası Kongre'), ('saha', 'Saha Çalışması'), ('diger', 'Diğer')], default='diger', max_length=20, verbose_name='Etkinlik Türü')),
                ...
                ('afis', models.ImageField(blank=True, null=True, upload_to='etkinlikler/fizyoterapi/afis/%Y/%m/%d/', verbose_name='Etkinlik Afişi')),
        ...
        migrations.CreateModel(
            name='FizyoterapiDersProgrami',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('baslik', models.CharField(max_length=200, verbose_name='Başlık')),
                ('aciklama', models.TextField(blank=True, verbose_name='Açıklama')),
                ('dosya', models.FileField(upload_to='ders_programlari/fizyoterapi/', verbose_name='Dosya')),
                ('sinif', models.CharField(choices=[('1', '1. Sınıf'), ('2', '2. Sınıf'), ('3', '3. Sınıf'), ('4', '4. Sınıf'), ('yuksek_lisans', 'Yüksek Lisans'), ('doktora', 'Doktora'), ('tum', 'Tüm Sınıflar')], max_length=20, verbose_name='Sınıf / Program')),
        ...
        migrations.AlterModelOptions(
            ...
            options={'verbose_name': 'Fizyoterapi ve Rehabilitasyon Duyurusu', 'verbose_name_plural': 'Fizyoterapi ve Rehabilitasyon Duyuruları'},
        ),
    ]
