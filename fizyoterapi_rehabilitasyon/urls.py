# app_name: fizyoterapi_rehabilitasyon/urls.py

from django.urls import path
from . import views

app_name = 'fizyoterapi_rehabilitasyon'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.fizyoterapi_rehabilitasyon_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.fizyoterapi_rehabilitasyon_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.fizyoterapi_rehabilitasyon, name='fizyoterapi_rehabilitasyon'),
