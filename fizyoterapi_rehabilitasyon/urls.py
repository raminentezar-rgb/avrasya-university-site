...
urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.fizyoterapi_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.fizyoterapi_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.fizyoterapi_bolumu, name='fizyoterapi_rehabilitasyon'),
