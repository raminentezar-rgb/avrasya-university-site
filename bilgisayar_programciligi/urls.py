# app_name: bilgisayar_programciligi/urls.py

from django.urls import path
from . import views

app_name = 'bilgisayar_programciligi'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.bilgisayar_programciligi_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.bilgisayar_programciligi_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.bilgisayar_programciligi_bolumu, name='bilgisayar_programciligi'),
