# harita_kadastro/urls.py

from django.urls import path
from . import views

app_name = 'harita_kadastro'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.harita_kadastro_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.harita_kadastro_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.harita_kadastro_bolumu, name='harita_kadastro'),
