...
class DisTicaretEtkinlikAdmin(TranslationAdmin):
...
@admin.register(DisTicaretDuyuru)
class DisTicaretDuyuruAdmin(admin.ModelAdmin):
    list_display = ['baslik', 'fakulte', 'yayin_tarihi', 'yayinda']
    list_filter = ['yayinda', 'yayin_tarihi']
    search_fields = ['baslik', 'icerik']
    
    def get_queryset(self, request):
        return DisTicaretDuyuru.objects.all()

@admin.register(DisTicaretDersProgrami)
class DisTicaretDersProgramiAdmin(TranslationAdmin):
...
class DisTicaretFaaliyetGrubuAdmin(TranslationAdmin):
    list_display = ['baslik', 'faaliyet_turu', 'sira']
    list_filter = ['faaliyet_turu']
    list_editable = ['sira']

@admin.register(DisTicaretFaaliyet)
class DisTicaretFaaliyetAdmin(TranslationAdmin):
