...
urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.dis_ticaret_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.dis_ticaret_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.dis_ticaret_bolumu, name='dis_ticaret'),
