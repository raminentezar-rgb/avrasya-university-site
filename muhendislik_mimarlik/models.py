# muhendislik_mimarlik/models.py
from django.db import models
from django.urls import reverse
from duyurular.models import Duyuru

class MuhendislikMimarlikDuyuru(models.Model):
    # لینک به اطلاعیه اصلی
    ana_duyuru = models.OneToOneField(
        Duyuru, 
        on_delete=models.CASCADE,
        related_name='muhendislik_mimarlik_duyuru',
    ...
    # فایل‌های ضمیمه
    dosya = models.FileField(upload_to='muhendislik_mimarlik/duyurular/', blank=True, null=True, verbose_name="Dosya Eki")
    ...
    class Meta:
        verbose_name = "Mühendislik Mimarlık Duyurusu"
        verbose_name_plural = "Mühendislik Mimarlık Duyuruları"
    ...
    def get_absolute_url(self):
        return reverse('muhendislik_mimarlik:duyuru_detay', args=[self.id])
