...
def idari_faaliyetler_2024_2025(request):
    return render(request, 'beslenme_diyetetik/includes/idari_faaliyetler_2024_2025.html')

def diger_faaliyetler_2024_2025(request):
    return render(request, 'beslenme_diyetetik/includes/diger_faaliyetler_2024_2025.html')
