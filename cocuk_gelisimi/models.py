# app_name: cocuk_gelisimi/models.py
...
class CocukGelisimiDuyuru(Duyuru):
    """مدل پروکسی برای نمایش اطلاعیه‌های رشته کودک رشد"""
...
class CocukGelisimiEtkinlik(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('cocuk_gelisimi:etkinlik_detay', args=[self.slug])
...
class CocukGelisimiFaaliyetGrubu(models.Model):
    TUR_CHOICES = [
...
class CocukGelisimiFaaliyet(models.Model):
    grup = models.ForeignKey(CocukGelisimiFaaliyetGrubu, on_delete=models.CASCADE, related_name='faaliyetler', verbose_name="Faaliyet Grubu")
...
class CocukGelisimiFaaliyetGorseli(models.Model):
    faaliyet = models.ForeignKey(CocukGelisimiFaaliyet, on_delete=models.CASCADE, related_name='gorseller', verbose_name="Faaliyet")
    gorsel = models.ImageField(upload_to=f'faaliyetler/cocuk_gelisimi/', verbose_name="Görsel")
    sira = models.IntegerField(default=0, verbose_name="Sıralama")
