...
urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.agiz_dis_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.agiz_dis_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.agiz_dis_bolumu, name='agiz_dis'),
