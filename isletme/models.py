...
class IsletmeDuyuru(Duyuru):
    """مدل پروکسی برای نمایش اطلاعیه‌های مدیریت کسب و کار"""
...
class Isletme_Etkinlik(models.Model):
    ...
    afis = models.ImageField(
        upload_to='etkinlikler/isletme/afis/%Y/%m/%d/', 
        blank=True, 
        null=True,
    ...
    class Meta:
        ...
        verbose_name = "İşletme Etkinliği"
        verbose_name_plural = "İşletme Etkinlikleri"
...
class DersProgramiDosyaIsletme(models.Model):
    DOSYA_TURU_CHOICES = [
        ('pdf', 'PDF'),
        ('word', 'Word'),
        ('excel', 'Excel'),
    ...
    dosya = models.FileField(
        upload_to='ders_programlari_isletme/%Y/%m/%d/',
        verbose_name="Dosya"
    )
    ...
    class Meta:
        verbose_name = "Ders Programı Dosyası (İşletme)"
        verbose_name_plural = "Ders Programı Dosyaları (İşletme)"
