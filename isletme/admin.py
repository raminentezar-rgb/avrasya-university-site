...
@admin.register(Isletme_Etkinlik)
class Isletme_EtkinlikAdmin(admin.ModelAdmin):
...
@admin.register(DersProgramiDosyaIsletme)
class DersProgramiDosyaIsletmeAdmin(admin.ModelAdmin):
