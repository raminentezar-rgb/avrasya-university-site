...
urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.isletme_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.isletme_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک مدیریت کسب و کار
    path('', views.isletme, name='isletme'),
    path('tarihce/', views.isletme_tarihce, name='tarihce'),
    path('misyon_visyon/', views.isletme_misyon_visyon, name='misyon_visyon'),
    path('yonetimi/', views.isletme_yonetimi, name='yonetimi'),
