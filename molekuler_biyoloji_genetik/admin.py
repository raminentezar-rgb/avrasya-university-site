...
@admin.register(MolekulerBiyolojiGenetik_Etkinlik)
class MolekulerBiyolojiGenetik_EtkinlikAdmin(admin.ModelAdmin):
...
@admin.register(MolekulerBiyolojiGenetikDuyuru)
class MolekulerBiyolojiGenetikDuyuruAdmin(admin.ModelAdmin):
