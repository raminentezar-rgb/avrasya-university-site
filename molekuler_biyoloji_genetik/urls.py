# app_name: molekuler_biyoloji_genetik/urls.py

from django.urls import path
from . import views

app_name = 'molekuler_biyoloji_genetik'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.molekuler_biyoloji_genetik_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.molekuler_biyoloji_genetik_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.molekuler_biyoloji_genetik_bolumu, name='molekuler_biyoloji_genetik'),
