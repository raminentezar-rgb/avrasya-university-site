# app_name: saglik_kurumlari/urls.py

from django.urls import path
from . import views

app_name = 'saglik_kurumlari'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.saglik_kurumlari_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.saglik_kurumlari_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.saglik_kurumlari_bolumu, name='saglik_kurumlari'),
