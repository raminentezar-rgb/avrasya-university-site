...
class SaglikKurumlariEtkinlikAdmin(TranslationAdmin):
...
@admin.register(SaglikKurumlariDuyuru)
class SaglikKurumlariDuyuruAdmin(admin.ModelAdmin):
    list_display = ['baslik', 'fakulte', 'yayin_tarihi', 'yayinda']
    list_filter = ['yayinda', 'yayin_tarihi']
    search_fields = ['baslik', 'icerik']
    
    def get_queryset(self, request):
        return SaglikKurumlariDuyuru.objects.all()

@admin.register(SaglikKurumlariDersProgrami)
class SaglikKurumlariDersProgramiAdmin(TranslationAdmin):
...
class SaglikKurumlariFaaliyetGrubuAdmin(TranslationAdmin):
    list_display = ['baslik', 'faaliyet_turu', 'sira']
    list_filter = ['faaliyet_turu']
    list_editable = ['sira']

@admin.register(SaglikKurumlariFaaliyet)
class SaglikKurumlariFaaliyetAdmin(TranslationAdmin):
