...
from .models import YeniMedyaIletisimDuyuru, YeniMedya_Etkinlik, YeniMedyaDersProgrami, YeniMedyaIletisimFaaliyetGrubu
...
def idari_faaliyetler(request):
    gruplar = YeniMedyaIletisimFaaliyetGrubu.objects.filter(faaliyet_turu='idari').prefetch_related('faaliyetler__gorseller')
    return render(request, 'yeni_medya_iletisim/includes/idari_faaliyetler.html', {'gruplar': gruplar})

def diger_faaliyetler(request):
    gruplar = YeniMedyaIletisimFaaliyetGrubu.objects.filter(faaliyet_turu='diger').prefetch_related('faaliyetler__gorseller')
    return render(request, 'yeni_medya_iletisim/includes/diger_faaliyetler.html', {'gruplar': gruplar})
