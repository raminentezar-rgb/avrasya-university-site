# app_name: spor_yoneticiligi/urls.py

from django.urls import path
from . import views

app_name = 'spor_yoneticiligi'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.spor_yoneticiligi_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.spor_yoneticiligi_duyuru_detay, name='detay'),

    # URLهای صفحات استاتیک
    path('', views.spor_yoneticiligi_bolumu, name='spor_yoneticiligi'),
