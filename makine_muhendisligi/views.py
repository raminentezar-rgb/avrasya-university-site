...
from .models import MakineMuhendisligiDuyuru, MakineMuhendisligiEtkinlik, MakineMuhendisligiDersProgrami, MakineMuhendisligiFaaliyetGrubu
...
def idari_faaliyetler(request):
    gruplar = MakineMuhendisligiFaaliyetGrubu.objects.filter(faaliyet_turu='idari').prefetch_related('faaliyetler__gorseller')
    return render(request, 'makine_muhendisligi/includes/idari_faaliyetler.html', {'gruplar': gruplar})

def diger_faaliyetler(request):
    gruplar = MakineMuhendisligiFaaliyetGrubu.objects.filter(faaliyet_turu='diger').prefetch_related('faaliyetler__gorseller')
    return render(request, 'makine_muhendisligi/includes/diger_faaliyetler.html', {'gruplar': gruplar})
