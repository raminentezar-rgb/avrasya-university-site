...
@admin.register(Makine_Etkinlik)
class Makine_EtkinlikAdmin(admin.ModelAdmin):
...
@admin.register(MakineDersProgrami)
class MakineDersProgramiAdmin(admin.ModelAdmin):
