...
class IktisadiIdariDuyuru(models.Model):
    ...
    # فایل‌های ضمیمه
    dosya = models.FileField(upload_to='iktisadi_idari/duyurular/', blank=True, null=True, verbose_name="Dosya Eki")
    ...
    def get_absolute_url(self):
        return reverse('iktisadi_idari:duyuru_detay', args=[self.id])
...
class IktisadiIdariDosya(models.Model):
    """مدل برای فایل‌های ضمیمه در اپ iktisadi_idari"""
    DOSYA_TURleri = [
        ('word', 'Word Belgesi'),
        ('pdf', 'PDF Belgesi'),
        ('excel', 'Excel Dosyası'),
    ...
    dosya = models.FileField(
        upload_to='iktisadi_idari/dosyalar/%Y/%m/%d/',
        verbose_name="Dosya"
    )
