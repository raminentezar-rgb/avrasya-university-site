# app_name: elektronorofizyoloji/urls.py

from django.urls import path
from . import views

app_name = 'elektronorofizyoloji'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.elektronorofizyoloji_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.elektronorofizyoloji_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.elektronorofizyoloji_bolumu, name='elektronorofizyoloji'),
