...
from .models import MuterimTercumanlikDuyuru, MuterimTercumanlikEtkinlik, MuterimTercumanlikDersProgrami, MutercimTercumanlikFaaliyetGrubu
...
def idari_faaliyetler(request):
    gruplar = MutercimTercumanlikFaaliyetGrubu.objects.filter(faaliyet_turu='idari').prefetch_related('faaliyetler__gorseller')
    return render(request, 'mutercim_tercumanlik/includes/idari_faaliyetler.html', {'gruplar': gruplar})

def diger_faaliyetler(request):
    gruplar = MutercimTercumanlikFaaliyetGrubu.objects.filter(faaliyet_turu='diger').prefetch_related('faaliyetler__gorseller')
    return render(request, 'mutercim_tercumanlik/includes/diger_faaliyetler.html', {'gruplar': gruplar})
