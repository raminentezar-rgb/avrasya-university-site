# app_name: mutercim_tercumanlik/urls.py

from django.urls import path
from . import views

app_name = 'mutercim_tercumanlik'

urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.mutercim_tercumanlik_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.mutercim_tercumanlik_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.mutercim_tercumanlik_bolumu, name='mutercim_tercumanlik'),
