# saglik_hizmetleri_myo/models.py
from django.db import models
from django.urls import reverse
from duyurular.models import Duyuru, DuyuruDosya

class SaglikHizmetleriMYODuyuru(models.Model):
    ana_duyuru = models.OneToOneField(
        Duyuru, 
        on_delete=models.CASCADE,
        related_name='saglik_hizmetleri_myo_duyuru',
    ...
    dosya = models.FileField(upload_to='saglik_hizmetleri_myo/duyurular/', blank=True, null=True, verbose_name="Dosya Eki")
    ...
    def get_absolute_url(self):
        return reverse('saglik_hizmetleri_myo:duyuru_detay', args=[self.id])
...
class SaglikHizmetleriMYODosya(models.Model):
    DOSYA_TURleri = [
        ('word', 'Word Belgesi'),
        ('pdf', 'PDF Belgesi'),
        ('excel', 'Excel Dosyası'),
    ...
    dosya = models.FileField(
        upload_to='saglik_hizmetleri_myo/dosyalar/%Y/%m/%d/',
        verbose_name="Dosya"
    )
