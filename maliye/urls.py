...
urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.maliye_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.maliye_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک مدیریت مالی
    path('', views.maliye, name='maliye'),
    path('tarihce/', views.maliye_tarihce, name='tarihce'),
    path('misyon_visyon/', views.maliye_misyon_visyon, name='misyon_visyon'),
    path('yonetimi/', views.maliye_yonetimi, name='yonetimi'),
