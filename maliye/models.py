...
class MaliyeDuyuru(Duyuru):
    """مدل پروکسی برای نمایش اطلاعیه‌های مدیریت مالی"""
...
class Maliye_Etkinlik(models.Model):
    ...
    afis = models.ImageField(
        upload_to='etkinlikler/maliye/afis/%Y/%m/%d/', 
        blank=True, 
        null=True,
    ...
    class Meta:
        ...
        verbose_name = "Maliye Etkinliği"
        verbose_name_plural = "Maliye Etkinlikleri"
...
class DersProgramiDosyaMaliye(models.Model):
    DOSYA_TURU_CHOICES = [
        ('pdf', 'PDF'),
        ('word', 'Word'),
        ('excel', 'Excel'),
    ...
    dosya = models.FileField(
        upload_to='ders_programlari_maliye/%Y/%m/%d/',
        verbose_name="Dosya"
    )
    ...
    class Meta:
        verbose_name = "Ders Programı Dosyası (Maliye)"
        verbose_name_plural = "Ders Programı Dosyaları (Maliye)"
