...
class MaliyeEtkinlikAdmin(TranslationAdmin):
...
@admin.register(MaliyeDuyuru)
class MaliyeDuyuruAdmin(admin.ModelAdmin):
    list_display = ['baslik', 'fakulte', 'yayin_tarihi', 'yayinda']
    list_filter = ['yayinda', 'yayin_tarihi']
    search_fields = ['baslik', 'icerik']
    
    def get_queryset(self, request):
        return MaliyeDuyuru.objects.all()

@admin.register(MaliyeDersProgrami)
class MaliyeDersProgramiAdmin(TranslationAdmin):
...
class MaliyeFaaliyetGrubuAdmin(TranslationAdmin):
    list_display = ['baslik', 'faaliyet_turu', 'sira']
    list_filter = ['faaliyet_turu']
    list_editable = ['sira']

@admin.register(MaliyeFaaliyet)
class MaliyeFaaliyetAdmin(TranslationAdmin):
