...
@admin.register(Maliye_Etkinlik)
class Maliye_EtkinlikAdmin(admin.ModelAdmin):
...
@admin.register(DersProgramiDosyaMaliye)
class DersProgramiDosyaMaliyeAdmin(admin.ModelAdmin):
