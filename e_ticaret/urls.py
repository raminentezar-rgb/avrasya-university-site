...
urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.e_ticaret_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.e_ticaret_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.e_ticaret_bolumu, name='e_ticaret'),
