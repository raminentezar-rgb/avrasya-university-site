...
class AdaletDuyuru(Duyuru):
    ...
    class Meta:
        proxy = True
        verbose_name = "Adalet Duyurusu"
        verbose_name_plural = "Adalet Duyuruları"
...
class AdaletEtkinlik(models.Model):
    ...
    class Meta:
        ...
        verbose_name = "Etkinlik (Adalet)"
        verbose_name_plural = "Etkinlikler (Adalet)"
...
class AdaletDersProgrami(models.Model):
    ...
    dosya = models.FileField(upload_to='ders_programlari/adalet/', verbose_name="Dosya")
    ...
    class Meta:
        verbose_name = "Ders Programı (Adalet)"
        verbose_name_plural = "Ders Programları (Adalet)"
