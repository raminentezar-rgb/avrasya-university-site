...
class AdaletFaaliyetGrubu(models.Model):
    TUR_CHOICES = [
...
class AdaletFaaliyet(models.Model):
    grup = models.ForeignKey(AdaletFaaliyetGrubu, on_delete=models.CASCADE, related_name='faaliyetler', verbose_name="Faaliyet Grubu")
...
class AdaletFaaliyetGorseli(models.Model):
    faaliyet = models.ForeignKey(AdaletFaaliyet, on_delete=models.CASCADE, related_name='gorseller', verbose_name="Faaliyet")
    gorsel = models.ImageField(upload_to=f'faaliyetler/adalet/', verbose_name="Görsel")
    sira = models.IntegerField(default=0, verbose_name="Sıralama")
