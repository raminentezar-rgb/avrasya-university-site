...
from .models import AdaletDuyuru, AdaletEtkinlik, AdaletDersProgrami, AdaletFaaliyetGrubu
...
def idari_faaliyetler(request):
    gruplar = AdaletFaaliyetGrubu.objects.filter(faaliyet_turu='idari').prefetch_related('faaliyetler__gorseller')
    return render(request, 'adalet/includes/idari_faaliyetler.html', {'gruplar': gruplar})

def diger_faaliyetler(request):
    gruplar = AdaletFaaliyetGrubu.objects.filter(faaliyet_turu='diger').prefetch_related('faaliyetler__gorseller')
    return render(request, 'adalet/includes/diger_faaliyetler.html', {'gruplar': gruplar})
