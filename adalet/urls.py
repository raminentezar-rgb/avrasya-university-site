...
urlpatterns = [
    # URLهای اطلاعیه‌ها
    path('duyurular/', views.adalet_duyurulari, name='liste'),
    path('duyurular/<slug:slug>/', views.adalet_duyuru_detay, name='detay'),
    
    # URLهای صفحات استاتیک
    path('', views.adalet_bolumu, name='adalet_bolumu'),
