...
from .models import SiyasetBilimiDuyuru, SiyasetBilimiEtkinlik, SiyasetBilimiDersProgrami
...
def idari_faaliyetler_2024_2025(request):
    return render(request, 'siyaset_bilimi/includes/idari_faaliyetler_2024_2025.html')

def diger_faaliyetler_2024_2025(request):
    return render(request, 'siyaset_bilimi/includes/diger_faaliyetler_2024_2025.html')
