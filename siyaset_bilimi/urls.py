...
urlpatterns = [
    ...
    # URLهای صفحات استاتیک علوم سیاسی
    path('', views.siyaset_bilimi, name='siyaset_bilimi'),
    path('tarihce/', views.siyaset_bilimi_tarihce, name='tarihce'),
    path('misyon_visyon/', views.siyaset_bilimi_misyon_visyon, name='misyon_visyon'),
    path('yonetimi/', views.siyaset_bilimi_yonetimi, name='yonetimi'),
