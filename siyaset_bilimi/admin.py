...
class SiyasetBilimiEtkinlikAdmin(TranslationAdmin):
...
class SiyasetBilimiDersProgramiAdmin(TranslationAdmin):
...
class SiyasetBilimiFaaliyetGrubuAdmin(TranslationAdmin):
    list_display = ['baslik', 'faaliyet_turu', 'sira']
    list_filter = ['faaliyet_turu']
    list_editable = ['sira']

@admin.register(SiyasetBilimiFaaliyet)
class SiyasetBilimiFaaliyetAdmin(TranslationAdmin):
