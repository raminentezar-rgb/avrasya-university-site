...
@admin.register(SiyasetBilimi_Etkinlik)
class SiyasetBilimi_EtkinlikAdmin(admin.ModelAdmin):
...
@admin.register(DersProgramiDosyaSiyasetBilimi)
class DersProgramiDosyaSiyasetBilimiAdmin(admin.ModelAdmin):
