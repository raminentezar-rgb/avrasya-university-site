# Generated by Django 4.2.25 on 2025-11-05 05:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='DersProgramiDosyaSiyasetBilimi',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('baslik', models.CharField(max_length=255, verbose_name='Dosya Başlığı')),
                ('aciklama', models.TextField(blank=True, verbose_name='Açıklama')),
                ('dosya', models.FileField(upload_to='ders_programlari_siyaset_bilimi/%Y/%m/%d/', verbose_name='Dosya')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('afis', models.ImageField(blank=True, null=True, upload_to='etkinlikler/siyaset_bilimi/afis/%Y/%m/%d/', verbose_name='Etkinlik Afişi')),
